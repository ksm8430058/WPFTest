...
namespace WpfNaverMovieFinder
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        {
            if (e.Key == System.Windows.Input.Key.Enter) btnSearch_Click(sender, e); //엔터시 검새되게
        }
        ///<summary>
        ///검색버튼 클릭 이벤트 핸들러
        ///</summary>
        ...
        private void btnSearch_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                Commons.ShowMessageAsync("검색", "영화검색완료!!");
        ...
        private void SearchNaverOpenAPI(string searchName)
        {
            ...
            this.DataContext = movieItems; //xaml에 데이터 할당
        }
        ...
        private void btnAddWatchList_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            List<TblFavoriteMovies> list = new List<TblFavoriteMovies>(); //FavoriteMovieItems(X)
        ...
        private void btnDelWatchList_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            btnViewWatchList_Click(sender, e); //즐겨찾기 버튼클릭 이벤트 실행
        ...
        private void btnWatchTrailer_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            var trailerwindow = new TrailerWindow(movieName); //영화제목 받는 생성자
            trailerwindow.Owner = this; //MainWindow
            trailerwindow.WindowStartupLocation = WindowStartupLocation.CenterOwner; //메인윈도우 정중앙에 뜨게 
        ...
        private void grdResult_SelectedCellsChanged(object sender, System.Windows.Controls.SelectedCellsChangedEventArgs e)
        {
            ...
            {
                var movie = grdResult.SelectedItem as MovieItem; //MovieItem으로 형변환
                ...
                {
                    imgPoster.Source = new BitmapImage(new Uri(movie.Image, UriKind.Absolute));
                }
            }
            
            if(grdResult.SelectedItem is TblFavoriteMovies) //즐겨찾기
            {
                var movie = grdResult.SelectedItem as TblFavoriteMovies; //MovieItem으로 형변환
                if (string.IsNullOrEmpty(movie.Image))
                {
                    imgPoster.Source = new BitmapImage(new Uri("resource/No_Picture.jpg", UriKind.RelativeOrAbsolute));
                }
